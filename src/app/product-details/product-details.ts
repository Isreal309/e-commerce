            ...
            <div class="row-layout product-details">
              ...
              <div class="column-layout group_6">
                ...
                <div class="row-layout group_7">
                  <igc-rating size="medium" value="${this.value}" @igcChange="${(e: any) => this.value = e.detail}" class="rating"></igc-rating>
            ...
            <div class="column-layout also-purchased">
              ...
              <div class="row-layout group_12">
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-content class="body-content">
                    <div class="row-layout group_13">
                      <igc-rating size="small" value="${this.value}" @igcChange="${(e: any) => this.value = e.detail}" class="rating"></igc-rating>
                    </div>
                    <h6 class="content_4">
                      $59.90
                    </h6>
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_1">
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-content class="body-content">
                    <div class="row-layout group_13">
                      <igc-rating size="small" value="${this.value2}" @igcChange="${(e: any) => this.value2 = e.detail}" class="rating"></igc-rating>
                    </div>
                    <h6 class="content_4">
                      $19.90
                    </h6>
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_2">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-content class="body-content">
                    <div class="row-layout group_13">
                      <igc-rating size="small" value="${this.value3}" @igcChange="${(e: any) => this.value3 = e.detail}" class="rating"></igc-rating>
                    </div>
                    <h6 class="content_4">
                      $11.00
                    </h6>
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_3">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-content class="body-content">
                    <div class="row-layout group_13">
                      <igc-rating size="small" value="${this.value4}" @igcChange="${(e: any) => this.value4 = e.detail}" class="rating"></igc-rating>
                    </div>
                    <h6 class="content_4">
                      $24.50
                    </h6>
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_4">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_5">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_6">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_7">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card ?elevated="${true}" class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_8">
                      <span class="material-icons icon_2">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
