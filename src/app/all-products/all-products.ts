            ...
            <div class="column-layout products">
              <div class="row-layout group_2">
                ...
                <div class="row-layout group_3">
                  ...
                  <igc-button variant="flat" size="large" id="button" @click="${() => this.dropdown?.toggle(this.button)}" class="button">
                    <span>SORT BY</span>
              ...
              <div class="row-layout group_4">
                ...
                <igc-card class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_9">
                      <span class="material-icons icon">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_10">
                      <span class="material-icons icon">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_11">
                      <span class="material-icons icon">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
                ...
                <igc-card class="card">
                  ...
                  <igc-card-actions class="actions-content">
                    <igc-button variant="flat" slot="start" size="large" class="button_1 button_1_12">
                      <span class="material-icons icon">
                        add_shopping_cart
                      </span>
                      <span>ADD TO CART</span>
