          ...
          <div class="column-layout group">
            ...
            <div class="row-layout group_1">
              <div class="column-layout group_2">
                <igc-list class="list">
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Alternator1.jpg" size="large" slot="start" class="avatar"></igc-avatar>
                    <div>
                  ...
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Depositphotos_91150104_l-2015.jpg" size="large" slot="start" class="avatar"></igc-avatar>
                    <div>
                      <div class="row-layout group_3">
                  ...
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Depositphotos_114068560_l-2015.jpg" size="large" slot="start" class="avatar"></igc-avatar>
                    <div>
                      <div class="row-layout group_3">
                        <div class="row-layout group_8">
                          <p class="typography__body-1 text_5">
                  ...
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Depositphotos_20993125_l-2015.jpg" size="large" slot="start" class="avatar"></igc-avatar>
                    <div>
                      <div class="row-layout group_3">
                        <div class="row-layout group_4">
                          <p class="typography__body-1 content_1">
                  ...
                  <igc-list-item>
                    <igc-avatar src="/src/assets/Depositphotos_12011807_l-2015.jpg" size="large" slot="start" class="avatar"></igc-avatar>
                    <div>
                      <div class="row-layout group_3">
                        <div class="row-layout group_8">
                          <p class="typography__body-1 text_5">
